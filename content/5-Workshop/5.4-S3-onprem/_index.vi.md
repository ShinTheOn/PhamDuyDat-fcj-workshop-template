...
- [Chuẩn bị tài nguyên](5.4.1-prepare/)
- [Tạo một S3 Interface endpoint](5.4.2-create-interface-enpoint/)
- [Kiểm tra Interface endpoint](5.4.3-test-endpoint/)
- [Mô phỏng DNS on-premises](5.4.4-dns-simulation/)
