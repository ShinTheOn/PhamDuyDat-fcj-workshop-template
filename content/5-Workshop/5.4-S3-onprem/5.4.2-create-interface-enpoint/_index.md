...
5. Select two subnets in AZs `us-east-1a` and `us-east-1b`.
...
Congratulations on successfully creating the S3 interface endpoint. In the next step, we will test the interface endpoint.
